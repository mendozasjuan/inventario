...
<div style="display: block;" class="block_content tab_content " id="list">
            ...
            <table class="datos" cellpadding="0" cellspacing="0" width="100%">
<!--<div>-->
...
foreach ($this->listaProductos as $key => $value) {
    if($value['existencia'] <= $value['stock_minimo']){
        echo '<tr class="alarma">';
    }else{
        echo '<tr>';
    }
?>
